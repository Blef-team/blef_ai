...
class CFRAgent(agent.Agent):
    """ The AI trained using CFR """

    def __init__(self, base_url=None):
        super(CFRAgent, self).__init__(base_url)
        self.nickname = "Nashbog"
...
determine_action = CFRAgent.determine_action
